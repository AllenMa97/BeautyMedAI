...
class GlobalAttention(nn.Module):
    ...
    and a source matrix `H` of size `n x dim`, to an outputs
    of size `dim`.
    ...
    All models compute the outputs as
...
class MultiHeadedAttention(nn.Module):
    ...
    def forward(self, key, value, query, mask=None,
        ...
        Returns:
           ...
           * outputs context vectors `[batch, query_len, dim]`
